        ...
        <div class="row rounded border mt-2 shadow">
            ...
            <div class="row mt-2" v-if="true">
                <div class="col text-end">
                    <h5 class="mt-1">NOMBRE DE LA TOMA</h5>
                    <div class="card mt-5">
                ...
                <div class="col">
                    ...
                    <div class="row bg-light">
                        ...
                        <div class="col-4 mt-2">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Bodegas Seleccionadas</h5>
                                    <p class="card-text">
            ...
            <div class="row mt-2" v-if="false">
                <div class="col">
                    <h5 class="mt-1">PERSONALIZAR ITEMS TOMA</h5>
                    <div class="row bg-light">
                        <div class="col-8 mt-2">
                            <table class="table table-bordered table-hover table-condesed mi_table">
                                <thead>
            ...
            <div class="row mt-2" v-if="false">
                <div class="col">
                    ...
                    <div class="row">
                        <div class="col border bg-light">
                            <div class="row mt-2">
                                ...
                                <div class="col text-start">Este es el nombre de la toma</div>
                            </div>
                            <div class="row mt-2">
                    ...
                    <br>
                    <button class="btn btn-success btn-sm"> <i class="fa-solid fa-check"></i> Confirmar e Iniciar Toma</button>
                </div>
            </div>
            <!--/Paso 4-->
